<%-- 
    Document   : sellold
    Created on : Dec 17, 2016, 4:55:22 PM
    Author     : sakhawat
--%>
...
<html>
    <head>
        ...
        <title>Sell existing books</title>
    </head>
    <body>
        <%
            ...
            System.out.println("inside sellold jsp "+bookId);
        %>
    ...
    <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f8f4eb">
        <tr>
            ...
            <td>
                ...
                <form method="post" action="soldBookUpdated">
                    <input type="hidden" name="book id" value=<%= bookId %> /><br>
