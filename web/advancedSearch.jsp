<%-- 
    ...
    Created on : Dec 6, 2016, 11:29:49 PM
    Author     : sakhawat
--%>
    ...
    <body>
        ...
        <tr>
            ...
            <td>
                <p align="left">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <strong><font color="#007009">Advanced Search</font> </strong>
                </p>
                <form method="post" action="advancedSearchResult.jsp"> 
                    Name <input type="text" name="bookName" size="30"/><br><br>
                    Author <input type="text" name="authorName" size="30"/><br><br>
                    Publisher <input type="text" name="publisherName" size="30"/><br><br>
                    Category <input type="text" name="type" size="30"/><br><br>
                    <input type="submit" value="Search"/>
                </form>
            </td>
        </tr>
